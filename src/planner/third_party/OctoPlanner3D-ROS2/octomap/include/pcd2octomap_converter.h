...
public:
  ...
  void setInputScale(double input_scale);
  void setResolution(double resolution);
  void setMinPointsPerVoxel(int min_points_per_voxel);
  void setMinClusterVoxels(int min_cluster_voxels);
...
private:
  ...
  double input_scale_ = 1.0;         // Scale input cloud coordinates to meters
