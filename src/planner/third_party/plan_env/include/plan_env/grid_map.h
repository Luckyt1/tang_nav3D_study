...
struct MappingParameters {
  ...
  double dynamic_obstacle_timeout_s_;

  /* visualization and computation time display */
  double vis_height_, ground_height_, ground_filter_height_;
  double inflate_vis_z_min_, inflate_vis_z_max_;
  bool inflate_vis_use_z_slice_;
  bool show_occ_time_;
  int occ_interval_ms_, vis_interval_ms_;
...
public:
  ...
  bool hasRecentObservation() const;
  bool odomValid();
